...
use UserFrosting\Sprinkle\Frontend\Error\Renderer\JsonRenderer;
use UserFrosting\Sprinkle\Frontend\Error\Renderer\PlainTextRenderer;
use UserFrosting\Sprinkle\Frontend\Error\Renderer\WhoopsRenderer;
use UserFrosting\Sprinkle\Frontend\Error\Renderer\XmlRenderer;
use UserFrosting\Sprinkle\Frontend\Http\Concerns\DeterminesContentType;
...
class ExceptionHandler implements ExceptionHandlerInterface
{
    ...
    /**
     * @var \UserFrosting\Sprinkle\Frontend\Error\Renderer\ErrorRendererInterface
     */
     ...
     *
     * @return \UserFrosting\Sprinkle\Frontend\Error\Renderer\ErrorRendererInterface
     */
    protected function determineRenderer()
    {
        ...
        if ((!is_null($renderer) && !class_exists($renderer))
            || (!is_null($renderer) && !in_array('UserFrosting\Sprinkle\Frontend\Error\Renderer\ErrorRendererInterface', class_implements($renderer)))
        ) {
